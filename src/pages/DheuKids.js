          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-right relative">
              <div className="relative inline-block">
                ...
                <div 
                  className={`w-48 h-48 bg-gradient-to-br from-blue-100/80 via-cyan-100/80 to-blue-200/80 rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 transform hover:scale-110 shadow-2xl border-4 border-white/70 backdrop-blur-md ${
                    isCharacterSpeaking ? 'animate-bounce' : ''
                  }`}
            ...
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                {parameters.map((param, index) => (
                  <div
                    key={index}
                    className={`bg-white rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 border cursor-pointer ${
                      activeParameter === index ? 'border-blue-300 shadow-lg' : 'border-gray-200'
                    }`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {newsItems.map((news, index) => (
              <a
                ...
                className={`block bg-white rounded-xl p-5 shadow-sm hover:shadow-md transition-all duration-300 border ${
                  index === currentNews ? 'border-blue-300 shadow-md' : 'border-gray-200'
                }`}
              >
